        ...
        <div class="join_content">
            <div class="join_form">
                <form id="join_form" method="GET" action="/user2/V2Join.nhn?m=begin" >
                    <input type="hidden" id="token_sjoin" name="token_sjoin" value="5RNJbiYtxSIr1fx1">
                    <!-- 약관동의 -->
                    <div class="terms_p">
...
<div class="article">
    ...
    <div class="clause">
        ...
        <p class="clause__text">부정가입 및 징계기록 등의 부정이용기록은 부정 가입 및 이용 방지를 위하여 수집 시점으로부터 6개월간 보관하고 파기하고 있습니다.
            부정이용기록 내 개인정보는 가입인증 휴대폰 번호(만 14세 미만 회원의 경우 법정대리인 DI)가 있습니다.<br>
    ...
    <div class="clause">
        ...
        <p class="clause__text"><p class="clause__text">
            ...
            법령에서 보존의무를 부과한 정보에 대해서도 해당 기간 경과 후 지체없이 재생이 불가능한 방법으로 파기합니다.<br><br>
            전자적 파일 형태의 경우 복구 및 재생이 되지 않도록 기술적인 방법을 이용하여 안전하게 삭제하며,
            출력물 등은 분쇄하거나 소각하는 방식 등으로 파기합니다.<br><br>
...
<div class="policy_summary">
                ...
                <div class="group_join">회사, 동아리 등 단체에서 사용할 ID가 필요하세요? <a href="/user2/join/groupJoin.nhn?lang=ko_KR" class='btn_group_join'>단체 회원 가입</a></div>
